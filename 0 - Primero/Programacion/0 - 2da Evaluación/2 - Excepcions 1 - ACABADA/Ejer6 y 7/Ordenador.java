public class Ordenador {
    ...
    public Ordenador(String numeroSerie, int m_capacidade, String m_tipo, int m_velocidade,
     double d_capacidade, String d_tipo, int d_velocidade, String p_modelo,
      double p_velocidade, int prezo ) throws OrdenadorException, OrdenadorException2{
        ...
        if (p_modelo.equals("Lo que sea") && d_tipo.equals("otra cosa")) {
            throw new OrdenadorException2("Non pode ser creado", 002);
        }
